...
- [ ] Explain what a token is used for.
  ...
  A token is a unique string that authenticates the user and is usually stored in local storage.

- [ ] What steps can you take in your web apps to keep your data secure?

  Make sure user passwords are not visible when seeing other user data. Also not storing the password in local storage.

- [ ] Describe how web servers work.

  Web servers basically store code from the developer/ creator of the site and deliver the site code to users on request.   

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

    Create = POST request, Read = GET, Update = PUT, Delete = DELETE
